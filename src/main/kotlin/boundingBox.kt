...
//> .db $00, $02, $10, $15
//> .db $04, $04, $0c, $1c
//   SMB2J: entry 9 bottom edge $14 -> $16 (bullet bill / piranha plant bbox 2px taller)
private val boundBoxCtrlData_SMB1 = intArrayOf(
    0x02, 0x08, 0x0e, 0x20,
    0x03, 0x14, 0x0d, 0x20,
    0x02, 0x14, 0x0e, 0x20,
    0x02, 0x09, 0x0e, 0x15,
...
private val boundBoxCtrlData_SMB2J = intArrayOf(
    0x02, 0x08, 0x0e, 0x20,
    0x03, 0x14, 0x0d, 0x20,
    0x02, 0x14, 0x0e, 0x20,
    0x02, 0x09, 0x0e, 0x15,
...
fun System.boundingBoxCore(sprObjOffset: Int, relCoordOffset: Int) {
    ...
    val boundBoxCtrlData = if (variant == GameVariant.SMB2J) boundBoxCtrlData_SMB2J else boundBoxCtrlData_SMB1
