...
infix fun Byte.ushr(other: Byte): Byte = ((this.toInt() and 0xFF) ushr other.toInt()).toByte()
infix fun Byte.shr(other: Int): Byte = (this.toInt() shr other).toByte()
infix fun Byte.ushr(other: Int): Byte = ((this.toInt() and 0xFF) ushr other).toByte()
