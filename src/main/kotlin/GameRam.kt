...
class GameRam {
    ...
    // ---- $300-$3FF: VRAM Buffers / Object Data ----
    ...
    // ---- $400-$4FF: Move Force / Collision / Bounding Box ----
    ...
    // ---- $500-$6FF: Block Buffers / Misc State ----
    ...
    // ---- $700-$7FF: Player State / Game Variables / Sound / Display ----
    ...
    // ---- Non-RAM fields (not mapped to NES addresses) ----
